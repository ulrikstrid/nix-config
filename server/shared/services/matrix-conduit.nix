...
, ...
  ...
  services.matrix-conduit = {
    ...
    settings.global.turn_uris = [ "turn:turn.matrix.org?transport=udp" "turn:turn.matrix.org?transport=tcp" ];
  ...
  networking.firewall.allowedTCPPorts = [ 6167 6168 ];
  networking.firewall.allowedUDPPorts = [ 6167 6168 ];
}
